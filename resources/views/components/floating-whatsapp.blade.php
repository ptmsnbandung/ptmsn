...
<div class="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center gap-3">
    <!-- Invitation Bubble -->
    ...
    <a href="{{ $waUrl }}" target="_blank" rel="noopener noreferrer" class="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#38bdf8] text-[#050d1a] flex items-center justify-center shadow-[0_0_20px_rgba(56,189,248,0.45)] hover:scale-110 active:scale-95 transition-all duration-300 relative group" aria-label="Chat WhatsApp PT Media Solusi Network" title="Chat WhatsApp PT Media Solusi Network">
        <div class="absolute inset-0 rounded-full bg-[#38bdf8]/35 animate-ping pointer-events-none"></div>
        <iconify-icon icon="solar:chat-round-dots-bold" width="24" height="24" class="sm:w-7 sm:h-7 group-hover:rotate-12 transition-transform duration-300"></iconify-icon>
    </a>
</div>
